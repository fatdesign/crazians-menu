<?php
// ============================================
// CRAZIANS MENU - GITHUB PROXY
// ============================================
// Platziere diese Datei auf deinem Server:
// https://deine-agentur.at/crazians-proxy/proxy.php
//
...
define('ADMIN_PASSWORD', 'crazians2026');       // Passwort für das Admin-Panel
...
define('GITHUB_REPO', 'crazians-menu');        // Name des Repositories
...
$headers = [
    ...
    'User-Agent: CraziansMenuAdmin/1.0',
